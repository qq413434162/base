...
$query = "SELECT arc.id,arc.typeid,arc.senddate,arc.auditdate,arc.flag,arc.ismake,
arc.channel,arc.arcrank,arc.click,arc.title,arc.color,arc.litpic,arc.pubdate,arc.mid,arc.writer,arc.shorttitle
FROM `$maintable` arc
$whereSql
