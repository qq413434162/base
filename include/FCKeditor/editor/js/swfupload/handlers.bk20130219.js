...
function queueComplete(numFilesUploaded) {
	...
	for (var i=0, j = fileUploaded8swfUpload.length; i<j; ++i) {
        ...
        html = !isNaN(parseInt(width)) && parseInt(width) > 800 ? 'width="800"' : '';
        html = "<img " + html + " "+ (alt? ("alt='"+alt+"' "): '') +"src='"+ (document.getElementById('dd2').checked?(url.replace('.jpg', '_lit.jpg').replace('.jpeg', '_lit.jpeg').replace('.gif', '_lit.gif').replace('.png', '_lit.png')):url) +"'/>";
