...
class TypeUnit
{
    ...
    function DelType($id, $isDelFile)
    {
        ...
        $topinfos = $this->dsql->GetOne("SELECT moresite,siteurl,sitepath,apikey FROM `#@__arctype` WHERE id='".$typeinfos['topid']."'");
        ...
        $sitepath = $typeinfos['sitepath'];
        $siteurl = $typeinfos['siteurl'];
        $moresite = $typeinfos['moresite'];
        $ispart = $typeinfos['ispart'];
        $defaultname = $typeinfos['defaultname'];
        $apikey = $typeinfos['apikey'];
