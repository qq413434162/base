...
function curl($base_url, $query_data = array(), $method = 'get', $exe_timeout = 30, $conn_timeout = 30, $dns_timeout = 3600)
{
    $ch = curl_init();
    ...
    if ($method != 'get') {
//        var_dump($base_url . ((strpos($base_url, '?')) ? '&' : '?') . http_build_query($query_data));
    } else {
//        var_dump($base_url);
    }
